...
// let heroesTexto=JSON.stringify(heroes, ["name", "alias"], 4)
// let heroesTexto=JSON.stringify(heroes, null, 4)
...
const modifica=(prop, valor)=>{
    ...
    if(prop==="id"){
        ...
        return {
            idAnterior: valor, 
            idNuevo: contador,
            name: "prueba de un texto en prop name...", 
            // id: 900
        }
    }
...
let heroesTexto=JSON.stringify(heroes, modifica, 4)
console.log(heroesTexto, typeof heroesTexto)