...
db.heroes.find( {"enemies.0.name":"Joker"})
...
db.heroes.updateOne({name:"Hulk"}, {$set:{age:40}} )
db.heroes.updateOne({name:"Hulk"}, {$inc:{age:3}} )
db.heroes.updateOne({name:"Hulk"}, {$mul:{age:2}} )
db.heroes.updateOne({name:"Hulk"}, {$min:{age:50}} )
db.heroes.updateOne({name:"Hulk"}, {$min:{age:38}} )

db.heroes.updateOne({name:"Messi"}, {$set:{goles:99999}} )
